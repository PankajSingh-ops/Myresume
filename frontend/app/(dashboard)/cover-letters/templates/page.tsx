...
function TemplateCard({
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-20 hidden md:block opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-300 rounded-xl overflow-hidden bg-white ring-1 ring-black/10 theme-zinc isolate">
