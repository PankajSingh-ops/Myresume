            ...
            <main className="flex-1 py-20 px-6">
                <div className="mx-auto max-w-7xl">
                    <div className="text-center mb-16 max-w-2xl mx-auto">
                        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Professional Templates</h1>
                        <p className="text-lg text-muted-foreground">
                            Choose from our collection of ATS-friendly designs. All templates are fully customizable.
                        </p>
                    </div>
                    ...
                    <div className="mt-20 text-center bg-muted/30 border rounded-2xl p-12">
                        ...
                        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                            Our editor lets you customize typography, colors, margins, and section ordering.
                            Start with any base template and make it your own.
                        </p>
                        <Link
                            href="/register"
